...
# categóricas (Trat) con dos niveles ("Control","Med")
# y una variables continuas (Edad). La correlación de 
# la variable de respuesta con la continua es considerablemente
# alta, lo cual podemos notar en el gráfico de dispersión.


# La distribución de la variable respuesta
# respecto a las categóricas, se puede observar que 
# el comportamiento es bastante similar en ambas categorías.
# Las medianas son distintas y se encuentran
# al rededor de los 17 y el rango también es diferente
...
# es decir, $\beta_1 + \beta_3$ es el promedio del cambio en la generación de 
# anticuerpos al aumantar la edad que tiene el paciente en el grupo
# al que se le aplicó tratamiento médico.
...
# Entonces, $\beta_1$ es el promedio del cambio en la generación de 
# anticuerpos al cambiar la edad en un año al paciente en un grupo
# de control

# entonces para saber si la edad afecta de la misma forma
# la generación de anticuerpos en el grupo control
# que en el grupo que recibe el medicamento, la hipótesis nula propuesta
...
# Se rechaza $H_0$, encontramos evidencia estadística
...
# anticuerpos que tiene una persona de cero años dado que esta en el grupo de control.
# Como ya se había mencionado anteriormente, el coeficiente $\beta_1=-0.3091356$ 
# es el promedio del cambio en la generación de 
# anticuerpos al aumentarle la edad en un año al paciente en un grupo
# de control.
...
# El coeficiente $\beta_3$ se puede intermpretar como cuánto cambia el promedio
# de anticuerpos en un año al cambiar de un grupo a otro y como vimos
...
# podemos afirmar que el medicamento aumenta el número de anticuerpos, 
# pues entre las edades de 16 y 60 años la banda de confianza del tratamiento se
